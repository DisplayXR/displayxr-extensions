...
|---|---|:--:|:--:|---|
| `XR_DXR_display_info` | [`XR_DXR_display_info.h`](include/openxr/XR_DXR_display_info.h) | 18 | [spec](https://github.com/DisplayXR/displayxr-runtime/blob/main/docs/specs/extensions/XR_DXR_display_info.md) | Display dimensions, eye-tracking modes, and the data needed for asymmetric (Kooima) projection |
