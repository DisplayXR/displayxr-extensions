...
| `XR_DXR_wayland_surface_binding` | [`XR_DXR_wayland_surface_binding.h`](include/openxr/XR_DXR_wayland_surface_binding.h) | 1 | [spec](https://github.com/DisplayXR/displayxr-runtime/blob/main/docs/specs/extensions/XR_DXR_wayland_surface_binding.md) | App-provided wl_display and wl_surface (desktop Linux) |
